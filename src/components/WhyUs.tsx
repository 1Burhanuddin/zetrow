  ...
  <section id="why-us" className="py-8 bg-white scroll-mt-20" style={{ scrollMarginTop: '80px' }}>
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="text-5xl font-bold mb-6 pb-4 border-b-2">Why Choose <span className="text-primary">Zetrow?</span></h2>
      ...
      <div className="grid lg:grid-cols-2 gap-12 mb-16">
        <div className="space-y-8">
          {/* Trust */}
          <div className="rounded-lg h-40 shadow-lg p-8 border-2 border-primary">
        ...
        <div className="space-y-8">
          {/* Best Rates */}
          <div className="bg-white h-40 rounded-lg shadow-lg p-8 border-2 border-primary">
            <div className="flex items-center mb-4">
